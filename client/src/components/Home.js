          ...
          <div className="row product-items" id="product-items">
            {items &&
              items.map((item) => (
                <div
                  key={item._id}
                  className="col-10 col-sm-6 col-lg-4 mx-auto my-3"
                >
                  <div className="card single-item">
                    <div className="img-container">
                      <Link to={`/item/${item._id}`}>
                        <img
                          src={`../../../uploads/${item.itemFileName}`}
                          alt=""
        ...
        <div className="container">
          <div className="row" id="infosection">
            ...
            <div className="col-10 mx-auto col-md-6 col-lg-4 my-3">
              ...
              <h5 className="font-weight-bold text-uppercase">Online Order</h5>
            ...
            <div className="row">
              <div className="col-md-12 copy">
                <p className="text-center">
                  &copy; Copyright 2021 - Diamond Lane. All rights reserved.
                </p>
              </div>
            </div>
          </div>
